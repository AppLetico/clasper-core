# RFC: Create an observability plan for health checks and structured request logs, with
...
- `src/server/healthCheck.ts` <!-- WARNING: file not found -->- `src/server/requestLogger.ts` <!-- WARNING: file not found -->
