# RFC: Implement a lightweight /health endpoint and add JSON request/response logging m
...
- `dist/middleware/logging.js` <!-- WARNING: file not found -->- `dist/server/index.js`- `docs/CHANGELOG.md` <!-- WARNING: file not found -->- `tests/integration/health.test.js` <!-- WARNING: file not found -->- `tests/unit/logging.test.js` <!-- WARNING: file not found -->
## Alternatives Considered

- Keep current behavior without new planning workflow.

## Rollout Plan

- Start with one repository profile.
- Enable strict verified-reference mode after pilot.