...
if (startIndex === -1 || endIndex === -1 || content.indexOf(oldStrEnd) === -1) {
  console.log("Could not find start or end");
  process.exit(1);
}

const newToolbar = `<div style={{ padding: "20px 24px", borderBottom: "1px solid var(--border-subtle)", background: "var(--bg-sidebar)", display: "flex", flexDirection: "column", gap: "12px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              <button class="btn-ghost btn-sm" style={{ paddingLeft: 0, paddingRight: 4, fontWeight: 500 }} onClick={() => { reset(); load(); }}>Reset</button>
